...
type UserWithClass struct {
	...
	// 0 学生, 1 教师
	Standing *int8 `thrift:"Standing,3,optional" form:"standing" json:"standing,omitempty"`
}
...
var UserWithClass_Standing_DEFAULT int8

func (p *UserWithClass) GetStanding() (v int8) {
	if !p.IsSetStanding() {
		return UserWithClass_Standing_DEFAULT
	}
	return *p.Standing
}
...
func (p *UserWithClass) IsSetStanding() bool {
...
func (p *UserWithClass) writeField3(oprot thrift.TProtocol) (err error) {
	if p.IsSetStanding() {
		if err = oprot.WriteFieldBegin("Standing", thrift.BYTE, 3); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteByte(*p.Standing); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
type JoinClassReq struct {
	...
	InvitationCode *string `thrift:"InvitationCode,3,optional" form:"invitation_code" form:"invitation_code" json:"invitation_code,omitempty"`
}
